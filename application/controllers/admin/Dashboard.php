...
class Dashboard extends CI_Controller {
	...
	public function index()
	{
        ...
        $data['trs_masuk'] = $this->dashboard_model->laundry_masuk(6);
        $data['trs_keluar'] = $this->dashboard_model->laundry_keluar(6);
        $data['max_trs_masuk'] = max($data['trs_masuk']);
        $data['max_trs_keluar'] = max($data['trs_keluar']);
        $data['antrian'] = $this->dashboard_model->jumlah_status('1');
        $data['siap'] = $this->dashboard_model->jumlah_status('3');
